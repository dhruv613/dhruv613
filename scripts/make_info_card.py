...
ROWS = [
    ("host",),
    ("kv", "Role", "AI/ML Developer / Full Stack"),
    ("kv", "Focus", "Automation & Vibe Coding"),
    ("kv", "Now", "AI / Data Visualization / ML/DL"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "Python / NumPy / Pandas"),
    ("kv", "Web", "React / Node.js / MongoDB"),
    ("kv", "Tools", "Selenium / Tkinter / CustomTkinter"),
    ("kv", "Core", "Automation / Data Visualization"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Building practical AI-powered projects"),
    ("bul", "Learning linear algebra & probability"),
]
...
parts.append(f'<text x="{W/2}" y="{TITLEBAR_H/2 + 4}" fill="{MUTED}" font-size="12" '
             f'text-anchor="middle">dhruv@github: ~$ neofetch</text>')
...
for i, row in enumerate(ROWS):
    ...
    if kind == "host":
        inner = (f'<text x="{KEY_X}" y="{y:.1f}" font-size="14" font-weight="700">'
                 f'<tspan fill="{GREEN}">dhruv</tspan><tspan fill="{MUTED}">@</tspan>'
